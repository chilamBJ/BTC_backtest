...
echo ">>> 模拟盘后台: cd ${REMOTE_DIR} && PYTHONUNBUFFERED=1 nohup python3 scripts/run_trade.py seller --duration 2h >> trade_seller.log 2>&1 &"
echo ">>> 看模拟盘日志: ssh ${USER}@${SERVER} 'tail -f ${REMOTE_DIR}/trade_seller.log'"
